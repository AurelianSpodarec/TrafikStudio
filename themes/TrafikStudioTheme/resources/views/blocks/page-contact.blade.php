...
<div class="py-16">
      <div class="max-w-screen-xl px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg">
        <div class="flex flex-col justify-between">
          <div>
            <h2 class="text-4xl lg:text-5xl font-bold leading-tight">Contact us today to see how our team can help you!</h2>
            <div class="text-gray-700 mt-8">
              Hate forms? Send us an <span class="underline"><a href="mailto:hello@trafikstudio.co.uk">email</a></span> instead or give us a call at <span class="underline"><a href="tel:07751022563">07751022563</a></span>
            </div>
          </div>
            ...
            <svg class="w-full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
              ...
              <g opacity="0.1">
                ...
                <path
                  ...
                  transform="translate(-52 -162.63)" fill="#05a7af" />
                <path
              ...
              <ellipse cx="548" cy="493.13" rx="548" ry="8.86" fill="#05a7af" opacity="0.1" />
              <ellipse cx="548" cy="565.88" rx="548" ry="8.86" fill="#05a7af" opacity="0.1" />
              <ellipse cx="548" cy="341.3" rx="548" ry="8.86" fill="#05a7af" opacity="0.1" />
              <ellipse cx="548" cy="417.21" rx="548" ry="8.86" fill="#05a7af" opacity="0.1" />
              <path
                ...
                transform="translate(-52 -162.63)" fill="#05a7af" opacity="0.1" />
              <path
