<footer class="mt-16 md:mt-24" style="background-color: #141414; color: white;">
        ...
        <div class="py-10 px-4">
            ...
            <a class="text-white" href="{{ home_url('/') }}">
                ...
                <div class="flex align-middle items-center">
                    <svg style="stroke: #00ced8; margin-right: 10px;" width="60px"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 225 225" style="enable-background:new 0 0 225 225;" xml:space="preserve">
                        <style type="text/css">
    ...
    <x-section container="default" style="border-top: 1px solid #323232;">
